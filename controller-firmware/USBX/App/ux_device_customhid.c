...
/* Itt az adatot a hid_event.ux_device_class_hid_received_event_data tömbben találod,
	 a hosszát pedig a hid_event.ux_device_class_hid_received_event_length változóban. */
