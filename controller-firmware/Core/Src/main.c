...
int main(void)
{
  ...
  /* CRS Bekapcsolása - Javított verzió STM32C0-hoz */
  __HAL_RCC_CRS_CLK_ENABLE();

  /* A C0-nál a CRS nem az RCC része, hanem külön periféria: CRS->... */
  CRS->CR |= CRS_CR_AUTOTRIMEN; // Automatikus hangolás bekapcsolása
  CRS->CR |= CRS_CR_CEN;        // CRS számláló indítása
